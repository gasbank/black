...
public class PlatformCallbackHandler : MonoBehaviour {
    ...
    void OnIosSaveResult(string result) {
        PlatformInterface.instance.logger.LogFormat("PlatformCallbackHandler.OnIosSaveResult: {0}", result != null ? result : "(null)");
    ...
    void OnIosLoadResult(string result) {
        if (result.StartsWith("*****ERROR***** ")) {
            ...
            PlatformInterface.instance.logger.LogFormat("PlatformCallbackHandler.OnIosLoadResult: {0}", result != null ? result : "(null)");
