...
public class AchievePopup : MonoBehaviour
{
    ...
    void UpdateAchievementUI()
    {
        ...
        var data = Data.dataSet.AchievementData_MaxBlackLevel;
        ConDebug.Log("Data.dataSet.AchievementData_MaxBlackLevel.Count");
        ConDebug.Log(data.Count);

        data = Data.dataSet.AchievementData_MaxColoringCombo;
        ConDebug.Log("Data.dataSet.AchievementData_MaxColoringCombo.Count");
        ConDebug.Log(data.Count);
