...
public class ConfirmPopup : MonoBehaviour, IPlatformConfirmPopup {
    ...
    [SerializeField] Sprite riceClaimImageSprite;
    [SerializeField] Sprite riceClaimButtonImageSprite;
    [SerializeField] Sprite gemClaimImageSprite;
    [SerializeField] Sprite gemClaimButtonImageSprite;
    public Image popupImage;
    public LayoutElement popupImageLayoutElement;
    [SerializeField] Animator topAnimator;
    [SerializeField] InputField inputField;
    [SerializeField] Text inputFieldPlaceholderText;
    [SerializeField] Subcanvas subcanvas;
    [SerializeField] Image topImage;
    [SerializeField] RectTransform contentTopRect;
    [SerializeField] RectTransform popupImageParentRect;
    [SerializeField] Graphic skipRenderGraphic;
    [SerializeField] int autoCloseRemainSec = -1;
    [SerializeField] Text autoCloseText;

    [SerializeField] GameObject gatherButtonPowerDownToggleGroup;
    [SerializeField] GameObject customSpawnAtOnceButtonGroup;
    ...
    public void OpenPopup(string msg, Action onBtn1, Action onBtn2, Action onBtn3,
        ...
        if (onBtn1 != null) {
            ...
            this.button1Text.text = btn1Text;
        } else {
            button1.gameObject.SetActive(false);
        }

        this.onButton1 = onBtn1;
        // Button 2
        if (onBtn2 != null) {
            button2.gameObject.SetActive(true);
            this.button2Text.text = btn2Text;
        } else {
            button2.gameObject.SetActive(false);
        }

        this.onButton2 = onBtn2;
        // Button 3
        if (onBtn3 != null) {
            claimButton.gameObject.SetActive(true);
            this.claimButtonText.text = btn3Text;
    ...
    public void OpenInputFieldPopup(string msg, Action onYes, Action onNo, string titleText, Header header,
        ...
        inputField.keyboardType = validation == InputField.CharacterValidation.Integer ? TouchScreenKeyboardType.NumberPad : TouchScreenKeyboardType.Default;
    }
    ...
    public void OpenCoreIndexSelectionPopup(string msg, string titleText, string btn1Text, Action<int> buttonCallback) {
        OpenPopup(msg, Close, null, null, titleText, Header.Normal, btn1Text, null, "", "", "", false, null, null,
            WidthType.Normal, 0, ShowPosition.Center, Close, false, -1, null, null, null, false, true, CoreIndexSelectionMode.SimpleButton, buttonCallback);
    }

    public string MessageText { get => message.text; set => message.text = value; }
}